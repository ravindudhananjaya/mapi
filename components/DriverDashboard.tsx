            ...
            <div className="max-w-3xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <motion.div
                        initial={{ opacity: 0, x: 20 }}
                        animate={{ opacity: 1, x: 0 }}
                        className="flex bg-white p-1 rounded-lg shadow-sm border border-gray-200"
                    >
                        <button
                        ...
                        >
                            ...
                            {requests.length > 0 && <span className="bg-red-500 text-white text-xs px-1.5 rounded-full animate-pulse">{requests.length}</span>}
                        </button>
                    </motion.div>
                </div>
