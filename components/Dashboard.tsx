    ...
    <div className="min-h-screen bg-gray-50 py-12 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <button className="bg-red-600 text-white px-6 py-3 rounded-full shadow-lg hover:bg-red-700 animate-pulse font-bold flex items-center gap-2">
                      ...
                      <div>
                         ...
                         <div className="flex items-end gap-2 h-32 border-b border-gray-300 pb-1">
                            {[120, 125, 118, 130, 120].map((val, i) => (
                               <div key={i} className="flex-1 bg-blue-400 hover:bg-blue-600 rounded-t transition-all relative group" style={{ height: `${(val/150)*100}%` }}>
                      ...
                      <div>
                         ...
                         <div className="flex items-end gap-2 h-32 border-b border-gray-300 pb-1">
                            {[90, 95, 92, 110, 95].map((val, i) => (
                               <div key={i} className="flex-1 bg-green-400 hover:bg-green-600 rounded-t transition-all relative group" style={{ height: `${(val/150)*100}%` }}>
                                  <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity">{val}</span>
                               </div>
                            ))}
                         </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div className="space-y-6">
                        {recentVisits.map((visit) => (
                            <div key={visit.id} className="border border-gray-100 rounded-xl p-5 hover:bg-gray-50 transition-colors">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                   ...
                   <div className="flex flex-col items-center text-center">
                      ...
                      <div className="flex gap-2 w-full">
                         <button className="flex-1 flex items-center justify-center gap-2 py-2 bg-brand-teal text-white rounded hover:bg-teal-900">
                            <Phone className="h-4 w-4" /> Call
                         </button>
                         <button className="flex-1 flex items-center justify-center gap-2 py-2 bg-gray-100 text-gray-700 rounded hover:bg-gray-200">
        ...
        {/* AI Assistant FAB */}
        <button className="fixed bottom-8 right-8 bg-brand-teal text-white p-4 rounded-full shadow-2xl hover:bg-teal-700 transition-transform hover:scale-110 flex items-center gap-2 z-50">
